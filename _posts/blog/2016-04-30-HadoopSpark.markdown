...
The major disadvantage with Hadoop is it is batch-driven and not for real-time data processing. 

## Apache Spark

Apache Spark is an open source big data framework released in 2014 mainly to tackle the performance issue with big data computation. Spark has become more and more popular among data scientists who want to get an answer in real-time. 
